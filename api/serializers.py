...
class ApplySerializer(serializers.ModelSerializer):
    ...
    # user = UserDetailsSerializer(read_only=True,many=True,source='user.userdetails_set')
    class Meta:
        model = Apply
        fields = '__all__'
...
class UserDetailsSerializer2(serializers.ModelSerializer):
    ...
    user = UserDetailsSerializer(read_only=True,many=True,source = 'apply.user.userdetails_set')
...
class ApplicantAppSerializer(serializers.ModelSerializer):
    # post = UserDetailsSerializer2(read_only=True,many=True,source = 'apply.post_set')
    apply = AppliedSerializer()
    class Meta:
        model = Applicant
        fields = '__all__'
